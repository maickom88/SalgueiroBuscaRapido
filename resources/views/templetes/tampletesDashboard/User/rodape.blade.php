    ...
    <div class="container">
        <div class="row" style="z-index:-1 !important;">
            ...
            <span>© Salgueiro Busca Rapido 2020 . Todos os direitos resevados.</span> <br>
				<p>Templete Empresarial criado por  <a href="https://templatemag.com/">TemplateMag</a></p> <br>
				<a href={{route('privacidade')}}>Política de Privacidade</a> / <a href={{route('condicoes')}}>Termos e condições</a>
            </div>
            <div class="col-md-3">
                    <a target="_blank" href="https://www.facebook.com/salgueirosbr/"><i class="fa fa-facebook"></i></a>
                    <a target="_blank" href=""><i class="fa fa-instagram"></i></i></a>
                    <a target="_blank" href="https://api.whatsapp.com/send?phone=5587988382558"><i class="fa fa-whatsapp"></i></a>
            </div>
        </div>
    </div>
</section>
