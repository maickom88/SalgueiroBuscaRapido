				...
				<div class="col-md-6 "  style=" padding-left:20px;">
					<ul style="list-style:none;">
						@if ($user->permissions->user == 'sim')
								...
								<li class="mb-2"><a href={{route('dashboard')}} style="text-transform:none">Dashborad</a></li>
						...
						@elseif($user->permissions->empresario == 'sim')
								...
								<li class="mb-2"><a href={{route('painel')}} style="text-transform:none">Dashboard</a></li>
								<li class="mb-2"><a href={{route('')}} style="text-transform:none">Pagina da Empresa</a></li>
						...
						@elseif($user->permissions->adm == 'sim')	
							<li class="mb-2"><a  href="" style="text-transform:none">Perfil</a></li>
							<li class="mb-2"><a href="" style="text-transform:none">Dashboard</a></li>
							<li class="mb-2"><a href="" style="text-transform:none">Empresas</a></li>
							<li class="mb-2"><a href="" style="text-transform:none">Usúarios</a></li>
							<li class="mb-2"><a href="" style="text-transform:none">Mensagens</a></li>
							...
							<li class="mb-2"><a href="" style="text-transform:none">Sair da Conta</a></li>
						@endif
...
<div class="row" style="padding: 20px;">
	...
	<div class="col-md-6 mb-4 text-center" style="width: 100%;  border-bottom:1px solid rgba(255,255,255,0.7); padding:30px; ">
		...
		<p class="mt-4" style="font-size: 24px; margin-bottom:20px; font-weight:bold; ">{{$user->name}}</p>
		<a style="padding:10px;border-radius:5px; background:#24324F; color:cornsilk; text-decoration:none;" href="">Acessar Conta</a>
	</div>
	<div class="col-md-6 text-center ">
		<ul style="list-style:none;">
			<li class="mb-2"><a  href="" style="text-transform:none">Perfil</a></li>
			<li class="mb-2"><a href="" style="text-transform:none">Empresas Favoritas</a></li>
			<li class="mb-2"><a href="" style="text-transform:none">Notícias da Cidade</a></li>
			<li class="mb-2"><a href="" style="text-transform:none">Eventos da Cidade</a></li>
			<li class="mb-2"><a href="" style="text-transform:none">Sair da Conta</a></li>
			<div class="dropdown-divider mt-1 mb-2"></div>
			<li class="mb-2"><a href="" style="text-transform:none"> <i class="fas fa-user-plus"></i>  Indique um Amigo</a></li>
		</ul>
