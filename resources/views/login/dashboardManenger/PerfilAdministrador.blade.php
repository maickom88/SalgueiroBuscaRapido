...
@section('titulo', 'SALGUEIRO BUSCA RAPIDO - ADMINISTRADOR: PERFIL')



@section('perfilUser', 'active')
...
<div class="loader loader-bouncing "></div>
	<section class="wrapper site-min-height">
			<div class="row mt">
				<div class="col-lg-12">
					...
					<div class="col-md-4 profile-text">
						...
						<p>Permissão de Administrador <i class="fa fa-user-times"></i></p>
						<br>
					...
					<div class="col-md-4 centered">
							<div class="profile-pic">
								...
								<p><img src={{asset('img/profilezim.png')}} class="img-circle avatarImg"></p>
								@else
								<p><img  id="avatarImg" src="" class="img-circle avatarImg"></p>
								@endif
							</div>
						</div>
					</div>
			...
			<div class="form-group">
				<label class="col-lg-2 control-label">TELEFONE CONTATO</label>
				<div class="col-lg-6">
